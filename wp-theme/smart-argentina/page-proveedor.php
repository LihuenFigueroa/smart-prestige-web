<?php /* Template Name: Proveedor */ ?>
<?php
$smart_proveedor = smart_get_contenido('proveedor_contacto');
?>
<?php get_header(); ?>
<?php get_template_part('partials/header'); ?>
  ...
  <main class="mx-auto px-5 md:px-8 pt-16 pb-16 md:pt-20 md:pb-24" style="margin-top: 48px;">
    ...
    <h1 class="font-smart-next font-normal text-[#141413] mb-12" style="font-size:40px; line-height:1.1;">Proveedor.</h1>

    <?php foreach ($smart_proveedor as $i => $bloque): ?>
    <?php if ($i > 0): ?>
