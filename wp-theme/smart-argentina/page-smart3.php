  ...
  <section id="elegi-tu-version" class="w-full bg-white" style="overflow:hidden;">
    ...
    <div id="vis-stage" style="overflow:visible;">
      ...
      <div id="vis-car-wrapper" style="position:relative; width:100%;">
        <img id="vis-car-back" src="<?php echo get_template_directory_uri(); ?>/assets/img/smart3/normalized/vis-pro-c1.png" alt="" style="width:100%; max-height:62vh; display:block; object-fit:contain;" />
        <img id="vis-car-front" src="<?php echo get_template_directory_uri(); ?>/assets/img/smart3/normalized/vis-pro-c1.png" alt="smart #3" style="position:absolute; inset:0; width:100%; height:100%; object-fit:contain; transition:opacity 0.4s cubic-bezier(0.25,0,0,1);" />
      </div>
          ...
          <div id="vis-color-row" style="display:flex; align-items:center; gap:10px; overflow:hidden; max-height:68px; padding:4px 5px 4px 0; transition:max-height 0.4s cubic-bezier(0.25,0,0,1), padding-top 0.4s cubic-bezier(0.25,0,0,1), padding-bottom 0.4s cubic-bezier(0.25,0,0,1);">
            ...
            <div id="vis-color-wrap" style="display:flex; gap:10px; transition:opacity 0.3s ease;">
              ...
              <div id="vis-swatches-Pro" style="display:flex; gap:10px;">
                <button class="vis-color-btn" data-color="pro1" data-img="<?php echo get_template_directory_uri(); ?>/assets/img/smart3/normalized/vis-pro-c1.png" style="width:28px;height:28px;border-radius:50%;background:linear-gradient(to bottom,#c4c020 50%,#1c1c1c 50%);border:none;cursor:pointer;box-shadow:0 0 0 2px #fff,0 0 0 3.5px #141413;"></button>
                ...
                <button class="vis-color-btn" data-color="pro6" data-img="<?php echo get_template_directory_uri(); ?>/assets/img/smart3/normalized/vis-pro-c6-v2.png" style="width:28px;height:28px;border-radius:50%;background:linear-gradient(to bottom,#111111 50%,#0a2c54 50%);border:none;cursor:pointer;"></button>
              </div>
              <div id="vis-swatches-Pro+" style="display:none; gap:10px;">
                ...
                <button class="vis-color-btn" data-color="pp6" data-img="<?php echo get_template_directory_uri(); ?>/assets/img/smart3/normalized/vis-prop-c6-v2.png" style="width:28px;height:28px;border-radius:50%;background:linear-gradient(to bottom,#111111 50%,#0a2c54 50%);border:none;cursor:pointer;"></button>
              </div>
            </div>
          </div>
        </div>
        ...
        window.switchVis = function(view) {
          ...
          if (view === 'ext') {
            ...
            if (intPanel && window.loadInteriorFor) {
              var linea = window.getVisLinea ? window.getVisLinea() : 'Pro';
