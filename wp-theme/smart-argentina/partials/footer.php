<footer class="font-smart-sans w-full bg-[#141413] px-5 md:px-14 pt-14 pb-10">
  <div class="max-w-[1320px] mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
      ...
      <div class="flex flex-col gap-2">
        <p class="text-white text-sm font-normal leading-5 opacity-50 mb-2 font-smart-sans">Secciones</p>
        <nav class="flex flex-col gap-2">
          <a href="<?php echo home_url('/'); ?>" class="text-white text-base leading-6 hover:opacity-70">Home</a>
      ...
      <!-- Col 2: sin título -->
      <div class="flex flex-col gap-2">
        <p class="hidden md:block text-white text-sm font-normal leading-5 opacity-50 mb-2 font-smart-sans">&nbsp;</p>
        <nav class="flex flex-col gap-2">
      ...
      <!-- Col 3: Modelos -->
      <div class="flex flex-col gap-2">
        <p class="text-white text-sm font-normal leading-5 opacity-50 mb-2 font-smart-sans">Modelos</p>
        <nav class="flex flex-col gap-2">
          <a href="<?php echo home_url('/smart-1/'); ?>" class="text-white text-base leading-6 hover:opacity-70">smart #1</a>
          <a href="<?php echo home_url('/smart-3/'); ?>" class="text-white text-base leading-6 hover:opacity-70">smart #3</a>
        </nav>
    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
      <div class="flex flex-wrap items-center gap-x-4 gap-y-2 text-[#BABFC4] text-sm">
        <div class="flex items-center gap-2 text-white text-sm">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-argentina.png" alt="" class="inline-block w-4 h-4 align-middle" />
          <span>Argentina</span>
        </div>
