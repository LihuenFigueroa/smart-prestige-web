...
<?php get_template_part('partials/header'); ?>
  ...
  <section class="relative w-full h-screen min-h-[640px] overflow-hidden">
    ...
    <div class="svc-hero-text-wrap absolute bottom-0 left-0 right-0 px-5 md:px-14 pb-8 md:pb-14 z-10">
      <h1 class="svc-hero-title font-smart-next font-bold text-white" style="font-size:45px; line-height:1.1;"><?php echo $smart_hero_servicios['titulo']; ?></h1>
    </div>
  </section>
  ...
  <section id="contacto" class="w-full bg-white py-12 md:pt-16 md:pb-16 px-5 md:px-14">
    <div class="max-w-[1320px] mx-auto flex flex-col md:flex-row gap-10 md:gap-16 md:items-start">
      ...
      <!-- Derecha: campos -->
      <div class="flex-1">
        <form id="form-contacto-servicios" novalidate onsubmit="submitContactForm(event, 'form-contacto-servicios')">
          <div class="border-b border-neutral-200 py-3"><input type="text" name="nombre" placeholder="NOMBRE *" data-req class="font-smart-sans w-full text-sm text-black bg-transparent outline-none placeholder:text-xs placeholder:tracking-widest placeholder:text-neutral-400" /></div>
          <div class="border-b border-neutral-200 py-3"><input type="text" name="apellido" placeholder="APELLIDO *" data-req class="font-smart-sans w-full text-sm text-black bg-transparent outline-none placeholder:text-xs placeholder:tracking-widest placeholder:text-neutral-400" /></div>
          <div class="border-b border-neutral-200 py-3"><input type="text" name="ciudad" placeholder="CIUDAD *" data-req class="font-smart-sans w-full text-sm text-black bg-transparent outline-none placeholder:text-xs placeholder:tracking-widest placeholder:text-neutral-400" /></div>
          <div class="border-b border-neutral-200 py-3"><input type="email" name="email" placeholder="CORREO ELECTRÓNICO *" data-req class="font-smart-sans w-full text-sm text-black bg-transparent outline-none placeholder:text-xs placeholder:tracking-widest placeholder:text-neutral-400" /></div>
          <div class="border-b border-neutral-200 py-3"><input type="tel" name="celular" placeholder="CELULAR *" data-req class="font-smart-sans w-full text-sm text-black bg-transparent outline-none placeholder:text-xs placeholder:tracking-widest placeholder:text-neutral-400" /></div>
          <div class="border-b border-neutral-200 py-3 relative">
            <select name="modelo" data-req class="font-smart-sans w-full text-xs bg-transparent appearance-none cursor-pointer outline-none" style="color:#9ca3af; letter-spacing:0.1em;" onchange="this.style.color=this.value?'#111827':'#9ca3af'; this.style.letterSpacing=this.value?'normal':'0.1em';">
          ...
          <div class="border-b border-neutral-200 py-3 relative">
            <select name="servicio" data-req class="font-smart-sans w-full text-xs bg-transparent appearance-none cursor-pointer outline-none" style="color:#9ca3af; letter-spacing:0.1em;" onchange="this.style.color=this.value?'#111827':'#9ca3af'; this.style.letterSpacing=this.value?'normal':'0.1em';">
