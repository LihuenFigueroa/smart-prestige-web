...
<?php get_template_part('partials/header'); ?>
  ...
  <section class="relative w-full h-screen min-h-[640px] overflow-hidden">
    ...
    <div class="con-hero-text-wrap absolute bottom-0 left-0 right-0 z-10" style="padding-left:56px; padding-bottom:74px;">
      <p class="con-hero-label font-smart-sans text-white" style="font-size:18px; margin-bottom:6px; opacity:0.9;"><?php echo esc_html($smart_hero_con['texto_secundario']); ?></p>
      <h1 class="con-hero-title font-smart-next font-bold text-white" style="font-size:45px; line-height:1.1;"><?php echo $smart_hero_con['titulo']; ?></h1>
    </div>
  </section>
  ...
  <script>
    ...
    (function () {
      if (window.innerWidth < 768) return; // en mobile no hace falta: las cards se apilan verticalmente
      ...
      ['track-cc1','track-cc2'].forEach(initHoverScroll);
    })();
