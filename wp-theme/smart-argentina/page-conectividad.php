...
<?php get_template_part('partials/header'); ?>
  ...
  <section class="relative w-full h-screen min-h-[640px] overflow-hidden">
    ...
    <div class="con-hero-text-wrap absolute bottom-0 left-0 right-0 z-10" style="padding-left:56px; padding-bottom:74px;">
      <p class="con-hero-label font-smart-sans text-white" style="font-size:16px; margin-bottom:8px; opacity:0.9;">Tecnología de integración</p>
      <h1 class="con-hero-title font-smart-next font-normal text-white" style="font-size:34px; line-height:1.1;">Tu auto piensa como vos.</h1>
    </div>
  </section>
